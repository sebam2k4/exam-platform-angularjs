angular.module('AppServices', [])
  ...
  .factory('ExamList', function () {
    return [
      ...
      { examId: '2', name: 'Calculus', provider: 'The Mathmagicians', image: 'img/math.jpg', imageAlt: 'math Formulas on brown wall', addedDate: '2017-03-01', type: 'math' },
      { examId: '3', name: 'Python', provider: 'The Monty Snake?', image: 'img/python.jpg', imageAlt: 'python snake', addedDate: '2017-04-23', type: 'coding' },
      { examId: '4', name: 'JavaScript Basics', provider: 'Code Institute', image: 'img/javascript-v2.jpg', imageAlt: 'javascript syntax on screen', addedDate: '2017-08-12', type: 'coding' },
      { examId: '5', name: 'Routing & Switching', provider: 'Cisco', image: 'img/routing.jpg', imageAlt: 'network of wires', addedDate: '2017-03-27', type: 'it_tech' },
      { examId: '6', name: 'Office365', provider: 'Cool guys at Microsoft', image: 'img/office.jpg', imageAlt: 'office interior with desk and shelves', addedDate: '2017-07-06', type: 'productivity' },
      { examId: '7', name: 'Security', provider: 'CompTIA', image: 'img/security.jpg', imageAlt: 'pin input screen on mobile device', addedDate: '2017-09-21', type: 'it_tech' },
